...
\inputFrame{SOAP sample request}{\tiny}{files/soap_request}
\inputFrame{SOAP sample response}{\tiny}{files/soap_response}
...
\inputFrame{WSDL sample}{\tiny}{files/wsdl_begin}
\centeredFrame{... about 100 lines of XML later ...}
\inputFrame{WSDL sample}{\tiny}{files/wsdl_end}
